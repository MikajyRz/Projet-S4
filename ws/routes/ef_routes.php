...
Flight::route('POST /prets/sauvegarder-simulation', ['EFController', 'sauvegarderSimulation']);
Flight::route('GET /prets/simulations', ['EFController', 'getSimulations']);
Flight::route('DELETE /prets/simulations/@id', ['EFController', 'deleteSimulation']);
...
// Routes pour simulations (sans doublons)
Flight::route('GET /prets/simulations', ['EFController', 'getSimulations']);
Flight::route('DELETE /prets/simulations/@id', ['EFController', 'deleteSimulation']);
Flight::route('POST /prets/sauvegarder-simulation', ['EFController', 'sauvegarderSimulation']);

// Ajouter les nouvelles routes pour les simulations
Flight::route('GET /prets/simulations', ['EFController', 'getSimulations']);
Flight::route('DELETE /prets/simulations/@id', ['EFController', 'deleteSimulation']);
Flight::route('POST /prets/sauvegarder-simulation', ['EFController', 'sauvegarderSimulation']);
